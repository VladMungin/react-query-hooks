...
function App() {
	...
	const { posts, refetchPosts } = useGetSomeData('posts')
	...
	return (
		<div className='relative max-w-[1200px] mx-auto'>
			<button
				className='block px-8 py-1 border-2 border-green-600 rounded-xl mx-auto mt-3 bg-green-500'
				onClick={e => {
					e.preventDefault()
					handleClick()
				}}
			...
			<div className='flex flex-col justify-between items-center max-w-[100%]'>
				{posts?.map(post => {
					...
					return (
						<div
							className='border-2 w-[100%] border-black rounded-xl my-4 p-2'
							key={id}
						>
						...
						<div className='relative w-auto my-6 mx-auto max-w-3xl'>
							...
							<div className='border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none'>
								...
								<div className='relative p-6 flex flex-col'>
									<input
										type='text'
										className='w-[100%] my-3 h-10 border-2 border-black rounded-xl px-3'
										onChange={e => {
